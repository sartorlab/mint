...
PULL_COMPARE_GROUP1_CHIP := $(shell echo ../bowtie2_bams/{$(GROUP1)}_hmc_pulldown_trimmed.fq.gz_aligned.bam)
PULL_COMPARE_GROUP1_INPUT := $(shell echo ../bowtie2_bams/{$(GROUP1)}_hmc_input_pulldown_trimmed.fq.gz_aligned.bam)
PULL_COMPARE_GROUP2_CHIP := $(shell echo ../bowtie2_bams/{$(GROUP2)}_hmc_pulldown_trimmed.fq.gz_aligned.bam)
PULL_COMPARE_GROUP2_INPUT := $(shell echo ../bowtie2_bams/{$(GROUP2)}_hmc_input_pulldown_trimmed.fq.gz_aligned.bam)
