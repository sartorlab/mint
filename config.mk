...
PULL_COMPARE_PEPR_GROUP1_CHIP := $(subst $(space),$(comma),$(PULL_COMPARE_PEPR_GROUP1_CHIP))
PULL_COMPARE_PEPR_GROUP1_INPUT := $(subst $(space),$(comma),$(PULL_COMPARE_PEPR_GROUP1_INPUT))
PULL_COMPARE_PEPR_GROUP2_CHIP := $(subst $(space),$(comma),$(PULL_COMPARE_PEPR_GROUP2_CHIP))
PULL_COMPARE_PEPR_GROUP2_INPUT := $(subst $(space),$(comma),$(PULL_COMPARE_PEPR_GROUP2_INPUT))
