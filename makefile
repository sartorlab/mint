...
$(PROJECT)/pull_hmc/pepr_peaks/%__PePr_up_peaks.bed :
	$(PATH_TO_PEPR) --input1=$(subst $(space),$(comma),$(PULL_COMPARE_GROUP1_INPUT)) --input2=$(PULL_COMPARE_GROUP2_INPUT) --chip1=$(PULL_COMPARE_GROUP1_CHIP) --chip2=$(PULL_COMPARE_GROUP2_CHIP) --name=$(COMPARISON) $(OPTS_PEPR)
