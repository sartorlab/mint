...
# Files
mSigResults=${ANALYSISDIR}/methylsig_calls/${COMPARISON}.txt
mSigTmpBedgraph=${ANALYSISDIR}/methylsig_calls/${COMPARISON}_tmp.bdg
mSigTmpSortedBedgraph=${ANALYSISDIR}/methylsig_calls/${COMPARISON}_tmp_sorted.bdg
mSigBigwig=${HUBDIR}/${COMPARISON}_methylSig.bw
