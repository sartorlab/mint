...
class_bed_file = sprintf('./analysis/classification_simple/%s_simple_classification.bed', humanID)
class_bb_file = sprintf('./analysis/summary/ucsc_trackhub/hg19/%s_simple_classification.bb', humanID)
